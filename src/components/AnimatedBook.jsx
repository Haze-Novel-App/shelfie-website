...
// import { ScrollTrigger } from 'gsap/ScrollTrigger';
// import { useGSAP } from '@gsap/react';
// import '../assets/Styles/AnimatedBook.scss'; // Ensure 'Styles' matches your folder name
// import BookCover from '../assets/imgs/bookCover/romantic.png';
...
//       const mesh = new THREE.Mesh(geo, pageMats);
//       mesh.position.x = BOOK_WIDTH / 2;
//       mesh.userData = { originalVertices: geo.attributes.position.array.slice(), link: data.link };
//       pivot.add(mesh);
//       bookGroup.add(pivot);
//       pageMeshes.push(mesh);
//     });
...
//         const end = 0.4 + (i * 0.15);
//         let localP = 0;
//         if (i < pageMeshes.length - 1 && currentScroll < START_CLOSING) {
//           localP = Math.min(Math.max((currentScroll - start) / (end - start), 0), 1);
//         }
//         const targetRot = -Math.PI * localP * 0.98;
//         pivot.rotation.y += (targetRot - pivot.rotation.y) * 0.1;
...
const AnimationBook = () => {
    ...
    const CONTENT = [
        {
            ...
            body: "1. AI-Powered: Read smarter and faster. We make long content easier to enjoy, with built-in monetization tools to help creators earn effortlessly.\n\n2. Text-to-Audio: Turn any text into smooth, natural-sounding audio. Listen hands-free with lifelike voices—perfect for multitasking or commuting.",
            img: "https://images.unsplash.com/photo-1495640388908-05fa85288e61?q=80&w=1000&auto=format&fit=crop",
            showButtons: false,
            link: null
        },
    ...
    useEffect(() => {
        ...
        const createTextTexture = (data) => {
            ...
            // Force canvas to wait for fonts to load
            if (document.fonts) {
