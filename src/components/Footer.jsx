        ...
        <div className="footer-col footer-brand">
          ...
          <div className="footer-contact">
            <a href="mailto:hello@shelfiebooks.in" className="email-link">
              Let’s connect at <span className="email-highlight">hello@shelfiebooks.in</span>
            </a>
          </div>
          ...
          <div className="footer-social">
            ...
            {/* Facebook */}
            <a href="https://www.facebook.com/share/1GHRh2S11j/?mibextid=wwXIfr" target="_blank" rel="noopener noreferrer" className="social-icon" aria-label="Facebook">
