...
//             <h2 className="section-title" style={{ color: '#341539' }}>For writers who want real reader engagement</h2>
        ...
        <div className="author-grid">
          ...
          <div className="author-text">
            ...
            <div className="author-download-badges">
              ...
              <a href="https://play.google.com/store/apps/details?id=com.jac.authorapp" className="badge-link">
                <img src="https://upload.wikimedia.org/wikipedia/commons/7/78/Google_Play_Store_badge_EN.svg" alt="Get it on Google Play" />
              </a>
            </div>
          </div>
